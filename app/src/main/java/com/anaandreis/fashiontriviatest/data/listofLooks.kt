...
val Looks: MutableList<Look> = mutableListOf(
    Look(R.drawable.teste_bella,"Versace", "1980", "photo"),
    Look(R.drawable.versace1, "Versace", "1990", "photo"),
    Look(R.drawable.balenciaga, "Balenciaga", "1980", "photo"),
    Look(R.drawable.gucci, "Gucci", "2000", "photo"),
    Look(R.drawable.yves, "Yves", "2010", "photo")
)
